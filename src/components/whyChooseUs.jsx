            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-6 col-lg-4 bg-white border p-3">
                        <img src={Dashboard} className="d-block w-100" style={{height:'250px'}}/>
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-4 bg-white border p-3">
                        <img src={EarnMoney} className="d-block w-100"  style={{height:'250px'}}/>
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-4 bg-white border p-3 mx-auto">
                        <img src={HappyUser} className="d-block w-100"  style={{height:'250px'}}/>
